          ...
          <div class="col-xl-7 ftco-animate">
	          	...
	          	<div class="row align-items-end">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" placeholder="" value="<?php echo $ho; ?>">
	                </div>
	              </div>
	              <div class="col-md-6">
	                <div class="form-group">
	                	<label for="lastname">Tên</label>
	                  <input type="text" class="form-control" placeholder="" value="<?php echo $ten; ?>">
	                </div>
                </div>
                <div class="w-100"></div>
		            <div class="col-md-12">
		            ...
		            <div class="col">
	                  ...
	                  <input type="text" class="form-control" placeholder="" value="<?php echo $diachi; ?>">
	                	</div>
		            </div>
					<div class="w-100"></div>
		            <div class="col">
	                  ...
	                  <input type="text" class="form-control" placeholder="" value="<?php echo $sdt; ?>">
	                	</div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
	              ...
	              <div class="col-md-6">
	                <div class="form-group">
	                  ...
	                  <input type="password" class="form-control" placeholder="" value="<?php echo $matkhau; ?>">
	                </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-12">
                	<div class="form-group mt-4">
										...
										if(!isset($taikhoan_id))
										{
											echo
											'<div class="radio">
										  <label class="mr-3"><input type="radio" name="optradio"> <a href="Login.php">Tạo một tài khoản? </a></label>
										</div>';
										}
										else
										{

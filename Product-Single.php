			...
			<div class="container">
				...
				<?php
					while($row=mysqli_fetch_array($result))
					{
						...
						<a href="Admin/'.$row['sanpham_hinhanh'].'" class="image-popup"><img src="Admin/'.$row['sanpham_hinhanh'].'" class="img-fluid" alt=""><input type="hidden" name="sanpham_hinhanh" value="Admin/'.$row['sanpham_hinhanh'].'"></a>
						</div>';
